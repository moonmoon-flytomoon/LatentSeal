...
def adjust_MedianBlur(x, kernel_size, sigma):
    """ Adjust contrast of an image
    Args:
        x: PIL image
        contrast_factor: contrast factor
    """
    return functional.gaussian_blur(x, kernel_size, sigma)

def adjust_GaussianBlur(x, kernel_size, sigma):
    """ Adjust contrast of an image
    Args:
        x: PIL image
        contrast_factor: contrast factor
...
def jpeg_compress_test(x, quality_factor):
    """ Apply jpeg compression to image
    Args:
        x: PIL image
        quality_factor: quality factor
